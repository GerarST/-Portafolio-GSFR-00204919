...
int main(){
    ...
    do{
        ...
        cout << "\t3) Eliminar\t4) Buscar\t\t\t 11) Mostrar libros de misterio\n";
        cout << "\t5) Invertir\t6) Vaciar\t\t\t 12) Eliminar todos los libros de ciencia ficcion\n";
        cout << "\t7) Cantidad\t8) Contar ocurrencias\t\t 13) Salir.\n";
        cout << "\t9) Acceder\t10) Mostrar libros en español\n";
        cout << "\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
            ...
            case 10: MostrarEspanol(); break;
            case 11: MostrarMisterio(); break;
            case 12: EliminarCC(); break;
            ...
            return;
             ...
             while(p != NULL && p->dato.genero == ciencia_ficcion){ 
                ...
                if(q == NULL)
                    ...
                    q->sig = p->sig;
                cout << "Libro de ciencia ficcion borrado!" << endl;
            }
        }
}
